 ...
 * ------------------------------------------------------------------------
 * Copyright (C) 2008-2013 JoomlaUX Solutions. All Rights Reserved.
	...
	private function onload_script() {
		...
		<script type="text/javascript">
			...
			window.addEvent('load', function() {
				...
				if(($('jform_params_hozorver0').checked == true && $('jform_params_horizontal_submenu_direction0').checked == false) || ($('jform_params_hozorver1').checked == true  && $('jform_params_vertical_submenu_direction1').checked == false)){
					 js_HideOptions('jform_params_n_navigation_animation');
					 js_ShowOptions('jform_params_navigation_animation');
				}else{
					 js_HideOptions('jform_params_navigation_animation');
					 js_ShowOptions('jform_params_n_navigation_animation');
				}
