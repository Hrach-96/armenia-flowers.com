...
<ul id="box<?php echo $params->get( 'class_sfx' ) ?>" class="vmproduct layout listproduct">
 <li>
  ...
  foreach ($product->categoryItem as $key=>$prod_cat) {
	...
	$odd++;
  ?>
    <div class="prod-row <?php if ($odd % 2 == 0) {
    echo "even\n";
  }
  else {
    echo "odd\n";
    ...
    <div class="browseImage ">
      ...
      //var_dump($time);
        ...
        <div id="CountSmall<?php echo $params->get( 'class_sfx' ) ?><?php echo $product->virtuemart_product_id.$params->get( 'class_sfx_feat' ); ?>" class="count_border">
         <script type="text/javascript">
        jQuery(function () {    
          jQuery('#CountSmall<?php echo $params->get( 'class_sfx' ) ?><?php echo $product->virtuemart_product_id.$params->get( 'class_sfx_feat' ); ?>').countdowns({
