	...
	<?php
		...
		foreach ($this->orderlist as $i => $row) {
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td align="left">
					<span class="divice-name"><?php echo JText::_('COM_VIRTUEMART_ORDER_LIST_MDATE'); ?></span>
				...
				<td align="left">
					<span class="divice-name"><?php echo JText::_('COM_VIRTUEMART_ORDER_LIST_TOTAL'); ?></span>
