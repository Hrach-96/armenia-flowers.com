...
<div class="manufacturer">
	...
	?>
        <span class="bold"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_DETAILS_MANUFACTURER_LBL') ?>:</span><a class="modal vm2" rel="{handler: 'iframe', size: {x: 320, y: 320}}" href="<?php echo $link ?>"><?php echo $text ?></a>
    <?PHP } ?>
</div>