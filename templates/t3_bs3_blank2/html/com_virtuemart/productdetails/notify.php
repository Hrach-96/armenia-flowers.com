...
<form method="post" action="<?php echo JRoute::_('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id='.$this->product->virtuemart_product_id.'&virtuemart_category_id='.$this->product->virtuemart_category_id, FALSE) ; ?>" name="notifyform" id="notifyform">
	<h3 class="module-title"><?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?></h3>
	...
	<div><span class="floatleft"><input type="text" name="notify_email" class="inputbox" value="<?php echo $this->user->email; ?>" /></span>
		 <input type="submit" name="notifycustomer"  class="button" value="<?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?>" title="<?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?>" />
	</div>
	</div>
