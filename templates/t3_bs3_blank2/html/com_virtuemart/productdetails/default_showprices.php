...
?><div class="call-a-question">
                                     	<a class="addtocart-button call ask-a-question askquestion2" data-fancybox-type="iframe"  rel="nofollow" href="<?php echo $askquestion_url ?>" ><?php echo JText::_('COM_VIRTUEMART_PRODUCT_ASKPRICE') ?></a>
                                    </div> <?php } } ?>
