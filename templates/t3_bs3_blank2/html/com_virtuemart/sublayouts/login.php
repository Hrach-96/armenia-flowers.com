...
<?php   }
    ...
    // XXX style CSS id com-form-login ?>
        <h4 class="module-title"><span><span><?php echo JText::_('DR_VIRTUEMART_CART_TITLE'); ?></span></span></h4>

    <form id="com-form-login" class="home-box" action="<?php echo JRoute::_('index.php', $this->useXHTML, $this->useSSL); ?>" method="post" name="com-login" >
    <div class="userdata">
        ...
        <div class="containers">
            <div class="row">
                <div class="col-xs-12 col-sm-5  col-md-5">
                     <input type="submit" name="Submit" class="default button" value="<?php echo vmText::_('COM_VIRTUEMART_LOGIN') ?>" />
                </div>
