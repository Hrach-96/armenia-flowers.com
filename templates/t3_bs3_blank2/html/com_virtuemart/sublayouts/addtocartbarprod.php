...
if (!VmConfig::get('use_as_catalog', 0)  ) { ?>
	...
	if (($stockhandle == 'disableit' or $stockhandle == 'disableadd') and ($product->product_in_stock - $product->product_ordered) < 1) { ?>
		<a href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&layout=notify&virtuemart_product_id=' . $product->virtuemart_product_id); ?>" class="addtocart-button  notify"><?php echo vmText::_ ('COM_VIRTUEMART_CART_NOTIFY') ?></a><?php
	} else {
		...
		<div class="wrapper">
            ...
            <span class="quantity-box">
	            <input type="text" class="quantity-input js-recalculate" name="quantity[]" data-errStr="<?php echo vmText::_ ('COM_VIRTUEMART_WRONG_AMOUNT_ADDED')?>" value="<?php echo $init; ?>" init="<?php echo $init; ?>" step="<?php echo $step; ?>" <?php echo $maxOrder; ?> />        
        	...
        	<?php if ($showwishlist) {?>
             ...
             <div class="proddetb wishlist list_wishlists<?php echo $product->virtuemart_product_id;?>">
           ...
           <?php } ?>     
        	<?php if ($showcompare) {?>            
             ...
             <div class="proddetb jClever compare_cat list_compare<?php echo $product->virtuemart_product_id;?>">
