...
<div class="contact-form">
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
		<fieldset>
			...
			<div class="row">
			<div class="control-group  first col-xs-4 col-md-4 col-sm-4">
			...
			<div class="control-group second col-xs-4 col-md-4 col-sm-4">
			...
			<div class="control-group tghree col-xs-4 col-md-4 col-sm-4">
			...
			<?php if ($this->params->get('show_email_copy')) { ?>
				<div class="control-group col-xs-12 col-md-12 col-sm-12">
			...
			<?php } ?>
			<div class="control-group next col-xs-12 col-md-12 col-sm-12">
			...
			<div class="form-actions"><button class="button validate reset2" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
