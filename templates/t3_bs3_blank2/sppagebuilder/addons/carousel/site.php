	...
	public function render() {
		...
		if(isset($this->addon->settings->sp_carousel_item) && count((array) $this->addon->settings->sp_carousel_item)){
			foreach ($this->addon->settings->sp_carousel_item as $key => $value) {
				...
				$contentposition = (isset($value->content_position) && $value->content_position) ? $value->content_position : '';
				$contentwidth = (isset($value->content_width) && $value->content_width) ? $value->content_width : '';

				$output  .= '<div class="sppb-carousel-item-inner">';
				$output  .= '<div class="sppb-carousel-caption">';
				$output  .= '<div style="width:'.$contentwidth.'%;" class="sppb-carousel-text '.$contentposition.'">';
