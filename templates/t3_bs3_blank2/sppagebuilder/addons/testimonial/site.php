...
class SppagebuilderAddonTestimonial extends SppagebuilderAddons {
	...
	public function render() {
		...
		$output .= '<span class="sppb-addon-testimonial-client"><strong>'.$name.'</strong><span class="sppb-addon-testimonial-client-url">'.$company.'</span></span>';
		$output .= $link ? '</a>' : '';
		$output .= '</div>';
