...
class SppagebuilderAddonHeading extends SppagebuilderAddons {
    ...
    public function css() {
        ...
        $textcolor = (isset($this->addon->settings->global_text_color) && $this->addon->settings->global_text_color != '') ? $this->addon->settings->global_text_color : '';
        $style .= (isset($this->addon->settings->title_text_transform) && $this->addon->settings->title_text_transform) ? 'text-transform: ' . $this->addon->settings->title_text_transform  . '!important; ' : '';
        $style .= (isset($this->addon->settings->global_text_color) && $this->addon->settings->global_text_color) ? 'color: ' . $this->addon->settings->global_text_color  . '!important; ' : '';
        $style .= (isset($this->addon->settings->title_fontsize) && $this->addon->settings->title_fontsize) ? 'font-size: ' . $this->addon->settings->title_fontsize  . 'px!important; ' : '';
        $style .= (isset($this->addon->settings->title_lineheight) && $this->addon->settings->title_lineheight) ? 'line-height: ' . $this->addon->settings->title_lineheight  . 'px!important; ' : '';
        $style .= (isset($this->addon->settings->title_font_style->weight) && $this->addon->settings->title_font_style->weight) ? 'font-weight: ' . $this->addon->settings->title_font_style->weight  . '!important; ' : '';
        
        $css = '';
        if ($style) {
            $css .= $addon_id . ' ' . $heading_selector . '.sppb-addon-title {' . $style . '}';
            //$css .= $addon_id . ' ' . $heading_selector . '.sppb-addon-title {color: ' . $textcolor . '}';
        }
