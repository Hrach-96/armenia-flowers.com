...
require_once dirname(dirname( __DIR__ )) .'/addons/articles/fields/blogselect.php';
...
array(
	...
	'attr'=>array(
		'general' => array(
			...
			'position_nav'=>array(
				'type'=>'checkbox',
				'title'=>JText::_('Position static / relative'),
				'std'=>1,
				'depends'=>array('show_carousel'=>'1')
			),
			'loop'=>array(
			...
			'autoplayTimeout'=>array(
				...
				'std'=>12000,
				'depends'=>array('show_carousel'=>'1','autoplay'=>'1')
			),
			'rewind'=>array(
				'type'=>'checkbox',
		...
		'options' => array(
			'used_masonry'=>array(
				'type'=>'checkbox',
				'title'=>JText::_('Used Masonry'),
				'desc'=>JText::_('Whether to used masonry plugin'),
				'values'=>array(
					1=>JText::_('COM_SPPAGEBUILDER_YES'),
					0=>JText::_('COM_SPPAGEBUILDER_NO'),
				),
			...
			'fancybox_icon'=>array(
				'type'=>'checkbox',
				'title'=>JText::_('Used Fancybox img'),
				'desc'=>JText::_('Whether to used Fancybox image'),
				'values'=>array(
					1=>JText::_('COM_SPPAGEBUILDER_YES'),
					0=>JText::_('COM_SPPAGEBUILDER_NO'),
				),
			...
			'show_tags'=>array(
				'type'=>'checkbox',
				'title'=>JText::_('Show Tags'),
				'desc'=>JText::_('Whether to show article tags.'),
				'values'=>array(
					1=>JText::_('COM_SPPAGEBUILDER_YES'),
					0=>JText::_('COM_SPPAGEBUILDER_NO'),
				),
			...
			'all_articles_btn_appearance'=>array(
				...
				'values'=>array(
					'flat' => JText::_('COM_SPPAGEBUILDER_GLOBAL_BUTTON_APPEARANCE_FLAT'),
