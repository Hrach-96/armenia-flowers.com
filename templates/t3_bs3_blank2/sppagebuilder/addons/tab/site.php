...
class SppagebuilderAddonTab extends SppagebuilderAddons {
	...
	public function render() {
        ...
        $nav_align = (isset($this->addon->settings->text_align) && $this->addon->settings->text_align) ? $this->addon->settings->text_align : 'sppb-nav-left';

		//Output
		$output  = '<div class="sppb-addon sppb-addon-tab ' . $class .' v'.$nav_align. '">';
		...
		foreach ($this->addon->settings->sp_tab_item as $key => $tab) {
                    ...
                    $icon_right = '';
                    $icon_left = '';
                    if(isset($tab->icon) && $tab->icon && $nav_icon_postion == 'top'){
                        $icon_top = '<span class="sppb-tab-icon tab-icon-block"><i class="fa ' . $tab->icon . '"></i></span>';
                    } elseif (isset($tab->icon) && $tab->icon && $nav_icon_postion == 'bottom') {
                        $icon_bottom = '<span class="sppb-tab-icon tab-icon-block"><i class="fa ' . $tab->icon . '"></i></span>';
                    } elseif (isset($tab->icon) && $tab->icon && $nav_icon_postion == 'right') {
	...
	public function css() {
		...
		$font_style .= (isset($this->addon->settings->nav_margin) && $this->addon->settings->nav_margin) ? 'margin: ' . $this->addon->settings->nav_margin . ';': '';
		...
		$font_style_xs .= (isset($this->addon->settings->nav_margin_xs) && $this->addon->settings->nav_margin_xs) ? 'margin: ' . $this->addon->settings->nav_margin_xs . ';': '';
                ...
                $nav_width = (isset($this->addon->settings->nav_width) && $this->addon->settings->nav_width) ? $this->addon->settings->nav_width : 0;
                $nav_width_sm = (isset($this->addon->settings->nav_width_sm) && $this->addon->settings->nav_width_sm) ? $this->addon->settings->nav_width_sm : 0;
                $nav_width_xs = (isset($this->addon->settings->nav_width_xs) && $this->addon->settings->nav_width_xs) ? $this->addon->settings->nav_width_xs : 0;
                
                $nav_gutter_right = (isset($this->addon->settings->nav_gutter) && $this->addon->settings->nav_gutter) ? 'padding-right: ' . $this->addon->settings->nav_gutter . 'px;': '';
                $nav_gutter_right_sm = (isset($this->addon->settings->nav_gutter_sm) && $this->addon->settings->nav_gutter_sm) ? 'padding-right: ' . $this->addon->settings->nav_gutter_sm . 'px;': '';
                $nav_gutter_right_xs = (isset($this->addon->settings->nav_gutter_xs) && $this->addon->settings->nav_gutter_xs) ? 'padding-right: ' . $this->addon->settings->nav_gutter_xs . 'px;': '';
                
                $nav_gutter_left = (isset($this->addon->settings->nav_gutter) && $this->addon->settings->nav_gutter) ? 'padding-left: ' . $this->addon->settings->nav_gutter . 'px;': '';
                $nav_gutter_left_sm = (isset($this->addon->settings->nav_gutter_sm) && $this->addon->settings->nav_gutter_sm) ? 'padding-left: ' . $this->addon->settings->nav_gutter_sm . 'px;': '';
                $nav_gutter_left_xs = (isset($this->addon->settings->nav_gutter_xs) && $this->addon->settings->nav_gutter_xs) ? 'padding-left: ' . $this->addon->settings->nav_gutter_xs . 'px;': '';
                    ...
                    <div class="sppb-addon-content sppb-tab {{data.style}}-tab">
                        <ul class="sppb-nav sppb-nav-{{ data.style }}">
                            <# _.each(data.sp_tab_item, function(tab, key){ #>
                                ...
                                #>
                                <li class="{{ active }}"><a data-toggle="sppb-tab" class="{{data.nav_text_align}}" href="#sppb-tab-{{ data.id }}{{ key }}">{{{icon_top}}} {{{icon_left}}} {{title}} {{{icon_right}}} {{{icon_bottom}}}</a></li>
                            <# }); #>
                        </ul>
