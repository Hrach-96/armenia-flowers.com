...
<div id="t3-mainbody" class="container t3-mainbody">
	<div class="row">
		...
		<!-- MAIN CONTENT -->
		<div id="t3-content" class="t3-content <?php if (!$prodcartbtn){ echo "fullwidth";} ?> <?php if (!$hide_asides) {echo "col-xs-12 col-sm-8 col-sm-push-4 col-md-9 col-md-push-3";}else {echo "col-xs-12 col-md-12 col-sm-12";} ?>">
