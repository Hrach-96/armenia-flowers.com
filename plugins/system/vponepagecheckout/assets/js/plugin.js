...
$Id: plugin.js 35 2015-02-08 12:04:28Z abhishekdas $
----------------------------------------------------------------------------------------------------------*/
VPOPC = window.VPOPC || {};
VPOPC.option = {};
...
if (typeof ProOPC === "undefined" || typeof ProOPC === undefined) {
    ...
    var ProOPC = {
        ...
        defaultSP: function() {
            ...
            if (VPOPC.option.AUTOPAYMENT && u != "exp") {
        ...
        setpayment: function(e) {
            ...
            if (jq(e).length > 0) {
                ...
                if (jq(e).data("pmtype") == "piraeus") {
                    jq(".vmpayment_cardinfo.piraeus").find("select, input").each(function() {
                        i = i + "&" + jq(this).attr("name") + "=" + jq(this).val()
                    })
                }
                ...
                ProOPC.ajaxPool["setpayment"] = jq.ajax({
                    dataType: "json",
                    url: VPOPC.option.URI,
                    data: "ctask=setpayment&ajax=1&virtuemart_paymentmethod_id=" + n + "&payment_data=" + r + i,
                    cache: false,
                    type: "post",
                    success: function(e) {
